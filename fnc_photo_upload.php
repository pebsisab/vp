...
function check_file_type($file){
	...
	if($image_check !== false){
		//kontrollime mis tüüpi fail see on (jpg, png jne)
...
/*function resize_photo_thumbnail($temp_photo, $thumbnail_max_w, $thumbnail_max_h){
	...
	//mis image objektile, mis objektist võtate, mis koordinaatidele x, y, mis koordinaatidelt võtta x, y, kui laialt ja kui kõrgelt, kui laia võtame, kui kõrge võtame
